...
public class ProductRestController {
    ...
    @RequestMapping(value = "/productReturnOne", produces = { "application/xml", "application/json" }, method = {
            RequestMethod.GET, RequestMethod.POST })
    public @ResponseBody Product showProductsOne() {
        return productService.getProducts().get(1);
    }
}
